...
const contactSalesModal = ({
  ...
  const contactEmail = "ambrosiaerp@gmail.com";
  ...
  return (
    <>
      {/* Backdrop */}
      <div
        className="fixed inset-0 z-40 transition-opacity bg-black/40 backdrop-blur-md"
        onClick={onClose}
      />
        ...
        <div className="bg-white rounded-lg shadow-2xl max-w-md w-full animate-in fade-in zoom-in-95 duration-200">
          ...
          <div className="p-6">
            <p className="text-gray-600 mb-6">
              Interested in our Enterprise plan? We'd love to discuss how
              Ambrosia can help your restaurant business grow.
            </p>
            ...
            <div className="space-y-3">
              ...
              <Button
                ...
                className={`w-full transition-all ${
                  copied
                    ? "bg-green-100 hover:bg-gray-200 text-green-700"
