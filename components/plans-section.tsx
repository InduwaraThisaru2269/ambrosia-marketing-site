...
import ContactSalesModal from "./contact-sales";
  ...
  const plans = [
    {
      ...
      features: [
        "Walk-in reservation management",
    ...
    },
    {
      ...
      features: [
        ...
        "AI driven sales and scheduling insights",
        "Custom branding",
      ],
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {plans.map((plan, index) => (
            ...
            >
              {/* Plan Header */}
              <div
                className={`p-6 sm:p-8 ${plan.highlighted ? "bg-red-50" : "bg-white"}`}
              >
              ...
              <div className="p-6 sm:p-8 border-t border-gray-200">
                <Button
                  onClick={() =>
                    plan.cta === "Contact Sales" && setIsContactModalOpen(true)
                  }
                  className={`w-full ${
                    plan.highlighted
